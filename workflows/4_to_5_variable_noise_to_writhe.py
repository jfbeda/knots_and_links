...
# Call using:
# python -m workflows.4_to_5_variable_noise_to_writhe
...
def main():
    input_root = "0_good_data/noisy_data/4_xyz_files_variable_noise"
    output_root = "0_good_data/noisy_data/5_writhe_files_variable_noise"
    ...
    for sub in os.listdir(input_root):
        ...
        # I should really replace the below line with some code that determines the number of points from the file
